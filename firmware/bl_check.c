...
int known_bootloader(int r, const uint8_t *hash) {
	...
	if (0 == memcmp(hash, "\x6a\xc5\x11\xb1\xc4\xf8\x04\xed\x68\x01\x4d\x39\xf7\xfb\x93\xfe\x64\x10\x58\xa5\xd9\xb4\xf2\x1b\x94\x4f\x6e\xc6\xd1\x48\xd8\xe9", 32)) return 1; // 1.5.0
	return 1;
}
